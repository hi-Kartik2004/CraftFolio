...
const data = {
  NavName: "Seems like you got lost, User Not Found!",
  FirstName: "User",
  LastName: "Not Found",
  NavSubtitle: "Kindly check the user name you entered in the URL",
  image:
  ...
  HeroSubtitle: () => (
    <React.Fragment className="text-muted-foreground">
      This Generally Happens when either there is a typo or the username shared
      with you is incorrect, however there is another way you can check for
      similar usernames head over to our github repo here and check the list of
      all the users who have signed up with us.
      <Button variant="link">
        <Link
