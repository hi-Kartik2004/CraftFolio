...
const data = {
  ...
  HeroSubtitle: `<React.Fragment className="text-muted-foreground">
  ...
  AboutMainDescription: `<React.Fragment className="text-muted-foreground">
      <p>
  ...
  AboutOtherDescription: `<React.Fragment className="text-muted-foreground">
