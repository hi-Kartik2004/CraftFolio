  ...
  const data = {
    ...
    HeroSubtitle: () => (
      <React.Fragment className="text-muted-foreground">
        This Generally Happens when either there is a typo or the username
        shared with you is incorrect, however there is another way you can check
        for similar usernames head over to our github repo here and check the
        list of all the users who have signed up with us.
        <Button variant="link">
          <Link
    ...
    AboutMainDescription: () => (
      <React.Fragment className="text-muted-foreground">
        <p>
          Having ventured into Frontend, Backend, and UI/UX design realms, akin
          to the versatile All Rounders in cricket who excel in both bowling and
          batting,{" "}
    ...
    AboutOtherDescription: () => {
      return (
        <React.Fragment className="text-muted-foreground">
          ...
          <span className="text-primary">
            {" "}
            I've been recommended by the Service Selection Board (SSB) for
            Officer entry in the Indian Navy, a testament{" "}
          </span>
    ...
    projectDetails: [
      ...
      },
      {
        projectId: 1,
        projectName:
          "Digital Clinic - A Web App Addressing Mental Health Issues",
        projectDescription:
